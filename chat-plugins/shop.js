...
exports.commands = {
	...
	shop: function (target, room, user) {
		...
		this.sendReplyBox(
			'<center><h3><b><u>Tienda Del Servidor Eternity</u></b></h3><table border="1" cellspacing="0" cellpadding="3" target="_blank"><tbody>' +
			'<tr><th>Art&iacute;culo</th><th>Descripci&oacute;n</th><th>Coste</th></tr>' +
			'<tr><td>Chatroom</td><td>Compra una Sala de chat. Será pública o privada en función del motivo de su compra. Si se detecta spam de comandos / saturación del modlog será borrada.</td><td>4000</td></tr>' +
			'<tr><td>CustomTC</td><td>Compra una Tarjeta de Entrenador personalizada (a partir de código html). Contactar con un administrador si el código es muy largo para un solo mensaje.</td><td>2000</td></tr>' +
			'<tr><td>CustomAvatar</td><td>Compra un avatar personalizado. Preferiblemente debe ser una imagen de pequeñas dimensiones y acorde a las reglas del servidor. Contactar con un Admin para obtener este art&iacute;culo.</td><td>2500</td></tr>' +
			...
			'<tr><td>Arreglor</td><td>Si ya tienes un avatar personalizado. Puedes cambiarlo por otro diferente.</td><td>500</td></tr>' +
			'<tr><td>Icono</td><td>Compra el derecho a tener un pokemon al lado de tu nick(<b>Como no tenmos un comando porfavor darle los pokedolares a un admin y el pondra su icono </b></td><td>1500</td></tr>' +
