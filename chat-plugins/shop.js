...
exports.commands = {
	...
	shop: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			'<tr><td>CustomAvatar</td><td>Compra un avatar personalizado. Preferiblemente debe ser una imagen de pequeñas dimensiones y acorde a las reglas del servidor. Contactar con un Admin para obtener este art&iacute;culo.</td><td>3000</td></tr>' +
